...
/**
 * Helper Class specific for only LEDStrips and matrices can calculate different
 * colors, and gets the individual color channels
 */
public class PixelColor {
	...
	/**
	 * Input a value 0 to 255 to get a Color value. The Colors are a transition r -
	 * g - b - back to r.
	 *

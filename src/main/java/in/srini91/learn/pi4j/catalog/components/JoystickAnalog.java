...
public class JoystickAnalog extends Component {
	...
	/**
	 * default normalization if true -> normalization from 0 to 1 if false ->
	...
	/**
	 * if true normalized axis from 0 to 1 center is 0.5, if false normalized axis
	 * from -1 to 1 center is 0
	 */
	...
	/**
	 * Builds a new JoystickAnalog component with default configuration for
	 * raspberry pi with ads1115 object
	 *
	...
	/**
	 * Builds a new JoystickAnalog component with custom input for x-, y-axis,
	 * custom pin for push button. ads component needs to be created outside this
	 * clas, other channels may be used for other components.
	 *
	 * @param pi4j           Pi4J context
	 * @param ads1115        ads object
	 ...
	 * @param normalized0to1 normalization axis if true -> normalization from 0 to 1
	 *                       if false -> normalization from -1 to 1
	 * @param push           additional push button on joystick
	 */
	public JoystickAnalog(Context pi4j, ADS1115 ads1115, int chanelXAxis, int chanelYAxis, double maxVoltage,
			boolean normalized0to1, PIN push) {
		this(new Potentiometer(ads1115, chanelXAxis, maxVoltage), new Potentiometer(ads1115, chanelYAxis, maxVoltage),
	...
	/**
	 * Sets or disables the handler for a value change event. This event gets
	 * triggered whenever the x-axis of the joystick is moving. Only a single event
	 * handler can be registered at once.
	 *
	...
	/**
	 * Sets or disables the handler for a value change event. This event gets
	 * triggered whenever the y-axis of the joystick is moving. Only a single event
	 * handler can be registered at once.
	 *
	 * @param task Event handler to call or null to disable
	 */
	...
	/**
	 * Sets or disables the handler for the onDown event. This event gets triggered
	 * whenever the button is pressed. Only a single event handler can be registered
	 * at once.
	 *
	 * @param task Event handler to call or null to disable
	 */
	...
	/**
	 * Sets or disables the handler for the onUp event. This event gets triggered
	 * whenever the button is no longer pressed. Only a single event handler can be
	 * registered at once.
	 *
	 * @param task Event handler to call or null to disable
	 */
	...
	/**
	 * Sets or disables the handler for the whilePressed event. This event gets
	 * triggered whenever the button is pressed. Only a single event handler can be
	 * registered at once.
	 *
	 * @param task Event handler to call or null to disable
	 */
	...
	/**
	 * Start reading of joystick value. Needs to be triggered before any value can
	 * be read.
	 *
	 * @param threshold     delta between old and new value to trigger new event (+-
	 *                      voltage)
	...
	/**
	 * Stop reading of joystick value. If triggered no new value from joystick can
	 * be read.
	 */
	public void stop() {

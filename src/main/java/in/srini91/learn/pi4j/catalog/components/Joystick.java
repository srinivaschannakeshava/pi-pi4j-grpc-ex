...
/**
 * Implementation of a joystick using 5 GPIO up, left, down, right and push with
 * Pi4J
 */
public class Joystick extends Component {
	...
	/**
	 * Creates a new joystick component with 5 custom GPIO address, a joystick with
	 * push button.
	 *
	...
	/**
	 * Creates a new joystick component with 4 custom GPIO address, so no push
	 * button.
	 *
	 * @param pi4j      Pi4J context
	 * @param addrNorth GPIO address of button up
	 ...
	 */
	public boolean buttonNorthIsDown() {
	 ...
	 */
	public boolean buttonNorthIsUp() {
		return bNorth.isUp();
	}
	 ...
	 * @return True if button is pressed
	 */
	public boolean buttonWestIsDown() {
		return bWest.isDown();
	}
	 ...
	 * @return True if button is pressed
	 */
	public boolean buttonSouthIsDown() {
	 ...
	 * @return True if button is depressed
	 */
	public boolean buttonSouthIsUp() {
		return bSouth.isUp();
	}
	 ...
	 * @return True if button is pressed
	 */
	public boolean buttonEastIsDown() {
		return bEast.isDown();
	}
	 ...
	 *
	 * @return True if button is pressed, False if button is not pressed or button
	 *         does not exist
	 */
	 ...
	 *
	 * @return True if button is depressed, False if button is pressed od button
	 *         does not exits
	 */
	 ...
	 */
	public DigitalInput getDigitalInputButtonNorth() {
	 ...
	 * @return Returns the Pi4J DigitalInput associated with this component.
	 */
	public DigitalInput getDigitalInputButtonWest() {
	 ...
	 * @return Returns the Pi4J DigitalInput associated with this component.
	 */
	public DigitalInput getDigitalInputButtonSouth() {
	 ...
	 * @return Returns the Pi4J DigitalInput associated with this component.
	 */
	public DigitalInput getDigitalInputButtonEast() {
	...
	/**
	 * disables all the handlers for every button and each onUp, onDown and
	 * WhilePressed Events
	 */

...
public class LEDButton extends Component {
	 ...
	 */
	public DigitalState btngetState() {
	 ...
	 */
	public Runnable btnGetOnUp() {
		return button.getOnUp();
	}

	/**
	 * @return the current Runnable that is set
	 */
	public Runnable btnGetOnDown() {
		return button.getOnDown();
	}

	/**
	 * @return the current Runnable that is set
	 */
	public Runnable btnGetWhilePressed() {
		return button.getWhilePressed();
	}
}